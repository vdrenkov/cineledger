...
public class GlobalExceptionHandlerTest {
  ...
  public void testHandleBadCredentialsException_onEndpointGetAllOrders_badRequest() throws Exception {
    ...
    mockMvc.perform(get(URI))
           ...
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
  ...
  public void testHandleIllegalArgumentException_onEndpointGetAllOrders_badRequest() throws Exception {
    ...
    mockMvc.perform(get(URI))
           .andExpect(status().isBadRequest())
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
             ExceptionMessages.INVALID_REQUEST_MESSAGE)));
  }
  ...
  public void testHandleUnsatisfiedServletRequestParameterException_onEndpointGetAllOrders_badRequest() throws
    ...
    movieMockMvc.perform(MockMvcRequestBuilders.get("/users").queryParam("joinDate", String.valueOf(
                  UserConstants.JOIN_DATE)))
                .andExpect(status().isBadRequest())
                .andExpect(jsonPath(ROOT_ERRORS).exists());
  }
  ...
  public void testHandleCategoryAlreadyExistsException_onEndPointGetAllCategories_conflict() throws Exception {
    ...
    mockMvc.perform(get(URI))
           .andExpect(status().isConflict())
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
             ExceptionMessages.CATEGORY_ALREADY_EXISTS_MESSAGE)));
  }

  @Test
  public void testHandleCinemaAlreadyExistsException_onEndPointGetAllCategories_conflict() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new CinemaAlreadyExistsException(
      ExceptionMessages.CINEMA_ALREADY_EXISTS_MESSAGE));
  ...
  public void testHandleProgramAlreadyExistsException_onEndPointGetAllCategories_conflict() throws Exception {
    ...
    mockMvc.perform(get(URI))
           .andExpect(status().isConflict())
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
             ExceptionMessages.PROGRAM_ALREADY_EXISTS_MESSAGE)));
  }

  @Test
  public void testHandleRoleAlreadyExistsException_onEndPointGetAllCategories_conflict() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new RoleAlreadyExistsException(
      ExceptionMessages.ROLE_ALREADY_EXISTS_MESSAGE));
  ...
  public void testHandleUserEmailAlreadyExistsException_onEndPointGetAllCategories_conflict() throws Exception {
    ...
    mockMvc.perform(get(URI))
           .andExpect(status().isConflict())
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
             ExceptionMessages.USER_EMAIL_ALREADY_EXISTS_MESSAGE)));
  }
  ...
  public void testHandleUsernameAlreadyExistsException_onEndPointGetAllCategories_conflict() throws Exception {
    ...
    mockMvc.perform(get(URI))
           .andExpect(status().isConflict())
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
             ExceptionMessages.USERNAME_ALREADY_EXISTS_MESSAGE)));
  }

  @Test
  public void testHandleProjectionNotFoundException_onEndPointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new ProjectionNotFoundException(
      ExceptionMessages.PROJECTION_NOT_FOUND_MESSAGE));
  ...
  public void testHandleCategoryNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new CategoryNotFoundException(
      ExceptionMessages.CATEGORY_NOT_FOUND_MESSAGE));
  ...
  public void testHandleCinemaNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new CinemaNotFoundException(
      ExceptionMessages.CINEMA_NOT_FOUND_MESSAGE));
  ...
  public void testHandleProgramNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new ProgramNotFoundException(
      ExceptionMessages.PROGRAM_NOT_FOUND_MESSAGE));
  ...
  public void testHandleUserNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new UserNotFoundException(
      ExceptionMessages.USER_NOT_FOUND_MESSAGE));
  ...
  public void testHandleDateNotValidException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new DateNotValidException(
      ExceptionMessages.DATE_NOT_VALID_MESSAGE));
  ...
  public void testHandleHallNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new HallNotFoundException(
      ExceptionMessages.HALL_NOT_FOUND_MESSAGE));
  ...
  public void testHandleItemNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new ItemNotFoundException(
      ExceptionMessages.ITEM_NOT_FOUND_MESSAGE));
  ...
  public void testHandleExistingItemException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new ItemAlreadyExistsException(
      ExceptionMessages.ITEM_ALREADY_EXISTS_MESSAGE));
  ...
  public void testHandleExistingMovieException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new MovieAlreadyExistsException(
      ExceptionMessages.MOVIE_ALREADY_EXISTS_MESSAGE));
  ...
  public void testHandleOrderNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new OrderNotFoundException(
      ExceptionMessages.ORDER_NOT_FOUND_MESSAGE));
  ...
  public void testHandleRoleNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new RoleNotFoundException(
      ExceptionMessages.ROLE_NOT_FOUND_MESSAGE));
  ...
  public void testHandleRoleNotChosenException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new RoleNotChosenException(
      ExceptionMessages.ROLE_NOT_CHOSEN_MESSAGE));
  ...
  public void testHandleMovieNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new MovieNotFoundException(
      ExceptionMessages.MOVIE_NOT_FOUND_MESSAGE));
  ...
  public void testHandleDiscountNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new DiscountNotFoundException(
      ExceptionMessages.DISCOUNT_NOT_FOUND_MESSAGE));
  ...
  public void testHandeDiscountNotValidException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new DiscountNotValidException(
      ExceptionMessages.DISCOUNT_CODE_NOT_VALID_MESSAGE));
  ...
  public void testHandleReviewNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new ReviewNotFoundException(
      ExceptionMessages.REVIEW_NOT_FOUND_MESSAGE));
  ...
  public void testHandleTicketNotFoundException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new TicketNotFoundException(
      ExceptionMessages.TICKET_NOT_FOUND_MESSAGE));
  ...
  public void testHallNotAvailableException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new HallNotAvailableException(
      ExceptionMessages.HALL_NOT_AVAILABLE_EXCEPTION));
  ...
  public void testNoAvailableTicketsException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new NoAvailableTicketsException(
      ExceptionMessages.NO_AVAILABLE_TICKETS_EXCEPTION));
  ...
  public void testNoAvailableItemsException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new NoAvailableItemsException(
      ExceptionMessages.NO_AVAILABLE_ITEMS_EXCEPTION));
  ...
  public void testHandleNotAuthorizedException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new NotAuthorizedException(
      ExceptionMessages.NOT_AUTHORIZED_MESSAGE));
  ...
  public void testHandleNotLoggedInException_onEndpointGetAllCategories_notFound() throws Exception {
    when(categoryService.getAllCategories()).thenThrow(new NotLoggedInException(ExceptionMessages.NOT_LOGGED_IN_MESSAGE));

    mockMvc.perform(get(URI))
           .andExpect(status().isUnauthorized())
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
             ExceptionMessages.NOT_LOGGED_IN_MESSAGE)));
  }
  ...
  public void testHandleDiscountAlreadyExistsException_onEndpointGetAllCategories_conflict() throws Exception {
    ...
    mockMvc.perform(get(URI))
           .andExpect(status().isConflict())
           .andExpect(MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(
             ExceptionMessages.DISCOUNT_ALREADY_EXISTS_MESSAGE)));
  }
  ...
  public void testHandleException_onEndpointGetAllCategories_internalServerError() throws Exception {
    ...
    mockMvc.perform(get(URI))
           .andExpect(status().isInternalServerError())
           .andExpect(
             MockMvcResultMatchers.jsonPath(ROOT_ERRORS, Matchers.containsInAnyOrder(ExceptionMessages.GLOBAL_EXCEPTION)));
  }
}
