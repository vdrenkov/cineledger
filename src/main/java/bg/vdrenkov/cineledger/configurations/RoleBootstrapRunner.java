...
public class RoleBootstrapRunner implements CommandLineRunner {
  ...
  private void bootstrapAdminUserIfConfigured() {
    ...
    final Role adminRole = roleRepository.findRoleByName(RoleConstants.DEFAULT_ADMIN_ROLE)
    ...
    final User admin = new User(
      ...
      bootstrapAdminEmail,
      StringUtils.hasText(bootstrapAdminFirstName) ? bootstrapAdminFirstName : "Admin",
      StringUtils.hasText(bootstrapAdminLastName) ? bootstrapAdminLastName : "User",
      LocalDate.now(),
      List.of(adminRole)
    );
